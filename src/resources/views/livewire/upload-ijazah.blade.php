<div class="akadify-wrapper">
    <div class="akadify-card">
        ...
        <div class="akadify-tutorial">
            <div class="akadify-tutorial-title">Cara Penggunaan</div>
            <ul>
                <li>Cari nama Anda di kolom pencarian siswa</li>
                <li>Upload ijazah dengan format <strong>JPG</strong> saja</li>
            </ul>
        </div>
